...
maxicode_image = "maxi.png"  # Replace with your actual image path

# Validate required files
for file in [javase_jar, core_jar, jcommander_jar, maxicode_image]:
    if not os.path.exists(file):
        print(f"Error: {file} not found!")
        exit(1)

# Java command to decode the MaxiCode
java_command = [
    "java", "-cp",
...
image = cv2.imread(maxicode_image)
